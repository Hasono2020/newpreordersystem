...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Copy temp numeric values to new supplier_id column.
        // REGEXP is MySQL-only; SQLite uses GLOB — both are no-ops on a fresh test DB.
        if (DB::connection()->getDriverName() === 'sqlite') {
            DB::statement("UPDATE products SET supplier_id = CAST(supplier_name AS INTEGER) WHERE supplier_name GLOB '[0-9]*'");
        } else {
