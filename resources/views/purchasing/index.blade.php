...
function syncAndEdit(poId, poNumber) {
    ...
    document.getElementById('processingMsg').textContent = 'Syncing purchase order with current demand. Please do not close this page.';
...
function createOrSyncAll(supplierId, supplierName) {
    ...
    document.body.appendChild(form);
    const ov = document.getElementById('processingOverlay');
    document.getElementById('processingMsg').textContent = 'Creating purchase order from all demand. This may take a moment for large suppliers. Please do not close this page.';
    ov.style.display = 'flex';
    form.submit();
}
