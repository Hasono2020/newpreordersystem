...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <div class="perm-group">
            ...
            @php
                $defaultVal = $defaults[$perm] ?? false;
                $customVal  = array_key_exists($perm, $customs) ? $customs[$perm] : $defaultVal;
                $isOverride = array_key_exists($perm, $customs) && $customs[$perm] !== $defaultVal;
            @endphp
            <div class="perm-row">
