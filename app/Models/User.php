    ...
    public static function roleDefaults(string $role): array
    {
        return match($role) {
            'admin' => [
                ...
                'cs_agents.view'   => true,  'cs_agents.create' => true,
                'cs_agents.edit'   => true,  'cs_agents.delete' => true,
            ...
            'finance' => [
                ...
                'cs_agents.view'   => false, 'cs_agents.create' => false,
                'cs_agents.edit'   => false, 'cs_agents.delete' => false,
